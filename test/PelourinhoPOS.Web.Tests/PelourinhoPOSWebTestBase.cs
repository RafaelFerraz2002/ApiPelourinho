...
{
    public abstract class PelourinhoPOSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PelourinhoPOSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PelourinhoPOSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PelourinhoPOSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PelourinhoPOSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PelourinhoPOSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PelourinhoPOSDbContext, Task<T>> func)
        {
            T result;
